...
this["JST"]["description"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<form action=\"/cards\" method=\"put\"><textarea name=\"description\" placeholder=\"Add a more detailed description\"></textarea><input type=\"submit\" value=\"Save\"> <a href=\"#\" class=\"close\"></a></form>";
},"useData":true});
