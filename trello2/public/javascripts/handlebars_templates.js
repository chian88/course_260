...
this["JST"]["card_detail"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "<li class=\"card_label\" data-id="
    ...
    + " style=\"background: "
    + ((stack1 = (helpers.find_color || (depth0 && depth0.find_color) || alias2).call(alias1,(depth0 != null ? depth0.id : depth0),((stack1 = (depths[1] != null ? depths[1].card : depths[1])) != null ? stack1.color_selection : stack1),{"name":"find_color","hash":{},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "\">"
    + ((stack1 = (helpers.find_title || (depth0 && depth0.find_title) || alias2).call(alias1,(depth0 != null ? depth0.id : depth0),((stack1 = (depths[1] != null ? depths[1].card : depths[1])) != null ? stack1.color_selection : stack1),{"name":"find_title","hash":{},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</li>";
  ...
  return "<div id=\"cover\"></div><div id=\"card\"><a href=\"\" class=\"close\"></a><section><h4>"
    ...
    + ((stack1 = helpers.each.call(alias3,((stack1 = (depth0 != null ? depth0.card : depth0)) != null ? stack1.labels : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "<li class=\"add_label card_label\"></li></ul></dd></dl>"
    + ((stack1 = (helpers.detailSchedule || (depth0 && depth0.detailSchedule) || helpers.helperMissing).call(alias3,((stack1 = (depth0 != null ? depth0.card : depth0)) != null ? stack1.due : stack1),{"name":"detailSchedule","hash":{},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    ...
    + ((stack1 = helpers.each.call(alias3,((stack1 = (depth0 != null ? depth0.card : depth0)) != null ? stack1.comments : stack1),{"name":"each","hash":{},"fn":container.program(4, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
...
this["JST"]["card"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "<li style=\"background: "
    + ((stack1 = (helpers.find_color || (depth0 && depth0.find_color) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.id : depth0),(depths[1] != null ? depths[1].color_selection : depths[1]),{"name":"find_color","hash":{},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ";\"></li>";
},"2":function(container,depth0,helpers,partials,data) {
    return "";
},"4":function(container,depth0,helpers,partials,data) {
  ...
  "<ul class=\"labels\">"
    ...
    + "</h4><ul class=\"status\">";
  stack1 = ((helper = (helper = helpers.check_subscribe || (depth0 != null ? depth0.check_subscribe : depth0)) != null ? helper : alias2),(options={"name":"check_subscribe","hash":{},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.noop,"data":data}),(typeof helper === alias3 ? helper.call(alias1,options) : helper));
  if (!helpers.check_subscribe) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  return buffer + ((stack1 = (helpers.scheduleStamp || (depth0 && depth0.scheduleStamp) || alias2).call(alias1,(depth0 != null ? depth0.due : depth0),{"name":"scheduleStamp","hash":{},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers["if"].call(alias1,((stack1 = (depth0 != null ? depth0.description : depth0)) != null ? stack1.length : stack1),{"name":"if","hash":{},"fn":container.program(4, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers["if"].call(alias1,((stack1 = (depth0 != null ? depth0.comments : depth0)) != null ? stack1.length : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</ul>";
},"useData":true,"useDepths":true});
...
this["JST"]["edit_label"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "<a href=\"#\" class=\"close\"></a><h5>Labels</h5><input type=\"text\" name=\"\" placeholder=\"Search labels...\"><ul>"
    ...
    + "</ul><a href=\"#\">Create a new label</a><a href=\"#\">Show more labels</a><a href=\"#\">Enable color blind friendly mode</a>";
},"useData":true,"useDepths":true});
